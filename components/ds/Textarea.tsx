  ...
  return (
    <div style={{ display: 'flex', flexDirection: 'column', gap: 6, width: '100%', ...containerStyle }}>
      ...
      <textarea
        ...
        disabled={disabled}
        required={required}
        onFocus={(e: React.FocusEvent<HTMLTextAreaElement>) => { setFocused(true); rest.onFocus && rest.onFocus(e); }}
        onBlur={(e: React.FocusEvent<HTMLTextAreaElement>) => { setFocused(false); rest.onBlur && rest.onBlur(e); }}
        {...rest}
        style={{

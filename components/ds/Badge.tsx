...
const TONES: Record<BadgeTone, { soft: { bg: string; fg: string }; solid: { bg: string; fg: string } }> = {
 ...
 */
export function Badge({ children, tone = 'neutral', solid = false, icon, dot = false, size = 'md', style = {}, ...rest }: BadgeProps) {

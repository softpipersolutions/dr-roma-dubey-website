...
import { Icon, Avatar, type IconName } from '@/components/ds';

export type PortalView = 'dashboard' | 'appointments' | 'reports' | 'messages';

const NAV: { key: PortalView; label: string; icon: IconName }[] = [
...
export function Sidebar({ active, onNavigate }: { active: PortalView; onNavigate: (v: PortalView) => void }) {
  return (
    <aside className="portal-sidebar" style={{ width: 250, flexShrink: 0, background: 'var(--surface-card)', borderRight: '1px solid var(--border-subtle)', display: 'flex', flexDirection: 'column', height: '100%', padding: '22px 16px' }}>
